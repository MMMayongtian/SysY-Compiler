...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MUL = 7,                        /* MUL  */
  YYSYMBOL_DIV = 8,                        /* DIV  */
  YYSYMBOL_LEFTP = 9,                      /* LEFTP  */
  YYSYMBOL_RIGHTP = 10,                    /* RIGHTP  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "NUMBER", "ADD",
  "SUB", "MUL", "DIV", "LEFTP", "RIGHTP", "EQUAL", "RESULT", "UMINUS",
...
{
      -7,     0,    -7,    -7,    -7,    30,    30,    -4,    -7,    17,
      -7,    35,    30,    30,    30,    30,    30,    -7,    -7,    21,
      -6,    -6,    -7,    -7,    -7
};
...
{
       5,     0,     1,    13,    12,     0,     0,     0,     4,     0,
      11,     0,     0,     0,     0,     0,     0,     3,    10,     0,
       6,     7,     8,     9,     2
};
...
{
       2,    15,    16,     3,     4,     0,     5,    12,     0,     6,
      10,    11,     7,     0,     8,     0,     0,    19,    20,    21,
      22,    23,    13,    14,    15,    16,    13,    14,    15,    16,
       0,    17,     0,     3,     4,    24,     5,     0,     0,     6,
      13,    14,    15,    16,     0,    18
};

static const yytype_int8 yycheck[] =
{
       0,     7,     8,     3,     4,    -1,     6,    11,    -1,     9,
       5,     6,    12,    -1,    14,    -1,    -1,    12,    13,    14,
      15,    16,     5,     6,     7,     8,     5,     6,     7,     8,
      -1,    14,    -1,     3,     4,    14,     6,    -1,    -1,     9,
       5,     6,     7,     8,    -1,    10
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* lines: lines RESULT EQUAL expr ';'  */
#line 46 "Yacc.y"
                                        { intTable[(int)yyvsp[-3]] = yyvsp[-1];}
#line 1111 "Yacc.tab.c"
    break;

  case 3: /* lines: lines expr ';'  */
#line 47 "Yacc.y"
                           { printf("%f\n", yyvsp[-1]);}
...
#line 1141 "Yacc.tab.c"
  ...
  case 10: /* expr: LEFTP expr RIGHTP  */
#line 55 "Yacc.y"
                              { yyval = yyvsp[-1]; }
...
#line 57 "Yacc.y"
                   { yyval = yyvsp[0]; }
#line 1159 "Yacc.tab.c"
    break;

  case 13: /* expr: ID  */
#line 58 "Yacc.y"
               { yyval = intTable[(int)yyvsp[0]]; }
