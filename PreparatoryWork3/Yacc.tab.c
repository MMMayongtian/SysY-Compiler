...
static const char *const yytname[] =
{
  ...
  "SUB", "MUL", "DIV", "LEFTP", "RIGHTP", "UMINUS", "';'", "$accept",
...
{
       4,     0,     1,     9,    10,     0,     0,     3,     0,    12,
       0,     0,     0,     0,     0,     2,    11,     5,     6,     7,
       8
};
...
#line 1152 "Yacc.tab.c"
  ...
  case 11: /* expr: LEFTP expr RIGHTP  */
#line 69 "Yacc.y"
                              { yyval = (char*)malloc(50 * sizeof(char));
                                strcpy(yyval,yyvsp[-1]);
                                }
#line 1160 "Yacc.tab.c"
    break;
