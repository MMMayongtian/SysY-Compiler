...
class Instruction {
   public:
    ...
    Instruction* getPrev() const { return prev; };
...
class NotInstruction : public Instruction {
   public:
    ...
    NotInstruction(Operand *dst, Operand *src, BasicBlock *insert_bb = nullptr) : Instruction(XOR, insert_bb){
        operands.push_back(dst);
...
class GepInstruction : public Instruction {
   ...
   public:
    // 用于数组寻址
    GepInstruction(Operand *dst, Operand *arr, Operand *idx, BasicBlock *insert_bb = nullptr, bool paramFirst = false) : Instruction(GEP, insert_bb){
        operands.push_back(dst);
