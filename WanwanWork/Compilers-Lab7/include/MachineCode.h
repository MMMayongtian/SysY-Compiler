...
class StackMInstrcution : public MachineInstruction {
   public:
    ...
    StackMInstrcution(MachineBlock* p,
                     int op,
...
class MachineBlock {
   ...
   public:
    ...
    void output();
    int getCond() const { return this->cond; };
    int getNo() {return no;};
...
class MachineFunction {
   ...
   public:
    ...
    int getStackSize() const { return this->stack_size; };
...
class MachineUnit {
   ...
   public:
    ...
    void insertGlobal(SymbolEntry* se) { global_list.push_back(se); };
