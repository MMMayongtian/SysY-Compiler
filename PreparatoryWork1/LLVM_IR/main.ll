...
define  i32 @main() #0 {
  ...
  %43 = call i32 (i32*, ...) bitcast (i32 (...)* @getarray to i32 (i32*, ...)*)(i32* noundef %42)
...
60: ;循环结束
  ...
  %64 = call i32 (i32, i32*, ...) bitcast (i32 (...)* @putarray to i32 (i32, i32*, ...)*)(i32 noundef 5, i32* noundef %63) ;putarray(5,array)
